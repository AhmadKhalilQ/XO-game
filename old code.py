...
def drawBoard(temporaryBoardPlaceholder):
    ...
    for i in range(1, 4):
        if i == 3:
            ...
            print(' ' + temporaryBoardPlaceholder[i] + ' |', end='')
    print('Board successfully displayed.')
...
def inputPlayerLetter():
    ...
    while True:
        ...
        if chosenLetterByUser in ['X', 'O']:
            break
        print("Error: Only 'X' or 'O' are allowed as inputs.")
...
def isWinner(tempBoardState, symbolToCheckFor):
    ...
    return (
        (tempBoardState[7] == symbolToCheckFor and tempBoardState[8] == symbolToCheckFor and tempBoardState[9] == symbolToCheckFor) or
        ...
        (tempBoardState[8] == symbolToCheckFor and tempBoardState[5] == symbolToCheckFor and tempBoardState[2] == symbolToCheckFor) or
...
def getBoardCopy(currentBoard):
    ...
    for item in currentBoard:
        duplicateCopyOfBoard.append(item)
